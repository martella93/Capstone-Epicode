...
public class RecensioneController {
    ...
    @GetMapping("/{esperienzaId}")
    public List<Recensione> getRecensioniByEsperienza(@PathVariable int esperienzaId) {
        return recensioneService.getRecensioneByEsperienza(esperienzaId);
